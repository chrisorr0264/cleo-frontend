...
//    const header = document.querySelector('.sliding-navbar');
...
//            localStorage.removeItem('navbarPinned');

//        }

//    } else {

//        console.error("Navbar element not found for pinning");
...
    // Initialize FancyBox with custom toolbar
...
                // Redirect to the edit mode page for the current image
...
        // Adjust container height and width based on rotation
...
            // Reset the container to the original layout
...
    // Check local storage for pin state

    //const navbar = document.querySelector('.sliding-navbar');

    //if (navbar && localStorage.getItem('navbarPinned') === 'true') {
...
    // Bind togglePin function to the button

    //document.querySelector('.pin-btn')?.addEventListener('click', togglePin);
